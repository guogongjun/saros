...
public interface IActivityQueuer {
   ...
   * IResourceActivity resource related activities} should be queued. The method returns all other
   * activities.
   *
   * <p>If flushing of the queue was previously requested, than this method will additionally return
   * activities from the queue.
   *
   * @param activities
